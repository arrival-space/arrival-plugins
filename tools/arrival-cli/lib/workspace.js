...
const FALLBACK_AGENTS_MD = [
    ...
    "",
    "`arrival push` persists to the LIVE space (live for the next load); it does NOT auto-refresh a",
    "browser that already has the space open — reload it to see changes. There's no CLI hot-reload yet.",
    "",
