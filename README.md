...
| [AI NPC](examples/ai-npc.mjs)                                           | LLM-driven NPC chat panel, built on the general `ArrivalSpace.ai.complete` API (free GLM by default, or the owner's OpenAI/Anthropic/GLM key)                                                                                                                                                                                                                                              |
| [AI Text Tool](examples/ai-text-tool.mjs)                               | Non-NPC use of `ArrivalSpace.ai.complete`: paste text, pick summarize/translate/rewrite, one-shot completion with a plugin-supplied system prompt                                                                                                                                                                                                                                          |
...
| [Piano](examples/piano.mjs)                                             | Playable 5-octave keyboard: silhouette outline + soft note on hover, full strike on click, `stopPropagation` to make keys solid to the pointer |
