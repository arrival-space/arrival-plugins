...
| [Piano](examples/piano.mjs)                                             | Playable keyboard: silhouette outline on hover, key press + synthesised note on click, `stopPropagation` to make keys solid to the pointer |
